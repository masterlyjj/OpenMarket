					...
					<form action="/qna/update" method="post">
						<div class="input-group mb-2">
							<span class="input-group-text">title</span> <input
								name="qna_title" maxlength="20" style="width: 250px;"
								value="${vo.qna_title}" readonly="readonly">
						</div>
						<div class="input-group mb-2">
							<span class="input-group-text">content</span> <input
								name="qna_content" maxlength="100" style="width: 250px;"
								value="${vo.qna_content}">
						</div>
						<div class="input-group mb-2">
							<span class="input-group-text">answer</span> <input
								name="qna_answer" maxlength="50" style="width: 250px;"
								value="${vo.qna_answer}">
						</div>
						<input name="qna_no" value="${vo.qna_no}" type="hidden"> <input
