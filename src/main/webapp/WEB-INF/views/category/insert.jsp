				...
				<div class="col p-4 d-flex flex-column position-static">
					...
					<form action="/category/insert" method="post">
						<div class="input-group mb-2">
							<span class="input-group-text">category</span> <select
								id="item_category1" name="item_category1">
								<option>선택하세요</option>
								<option value="direct">직접 입력</option>
								<c:forEach items="${list}" var="list">
									<option>${list.item_category}</option>
								</c:forEach>
							</select> <input name="item_category" id="item_category" value="카테고리"><br>
						</div>
						<div class="input-group mb-2">
							<span class="input-group-text">item</span> <input
								name="item_name" maxlength="30" style="width: 250px;">
						</div>
