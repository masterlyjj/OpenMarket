...
public class SearchController {
	...
	public String searchlist(@PathVariable("keyword") String keyword,
			@PathVariable("item_category") String item_category, @PathVariable("curPage") int curPage,
			SearchPageTO<ItemVO> spt, Model model) {
