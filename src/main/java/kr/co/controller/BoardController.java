...
public class BoardController {
	...
	public String update(@PathVariable("board_no") int board_no, @PathVariable("item_no") int item_no, BoardVO vo) {
	...
	public String updateui(@PathVariable("board_no") int board_no, @PathVariable("curPage") int curPage,
			@PathVariable("item_no") int item_no, Model model) {
	...
	public String read(@PathVariable("board_no") int board_no, @PathVariable("curPage") int curPage, Model model,
			HttpSession session) {
