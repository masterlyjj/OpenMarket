...
public class ItemController {
	...
	public String list(@PathVariable("item_category") String item_category, @PathVariable("curPage") int curPage,
			PageTO<ItemVO> pt, Model model) {
	...
	public ResponseEntity<Integer> getItme_no(@PathVariable("item_name") String item_name,
			@PathVariable("item_size") String item_size, @PathVariable("item_color") String item_color, Model model) {
		ResponseEntity<Integer> entity = null;
